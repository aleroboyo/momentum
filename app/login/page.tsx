  ...
  return (
    <div>
      ...
      <div className="px-4 font-inter md:text-lg md:mx-24 lg:mx-100">
        ...
        <div>
          <h4 className="hidden rounded-4xl bg-[#fff5d7] border-4 border-blue-50 lg:flex flex-col items-center px-2 py-4 my-6 font-bodoni md:flex-row md:justify-center md:gap-2 md:mb-10">Do not have an account?
            <span>
